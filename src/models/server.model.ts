...
import ticketUpdatesModel from './database/ticketUpdates.model';
import documentationModel from './database/documentation.model';
import employeeModel from './database/employee.model';
import employeeDeviceModel from './database/employeeDevice.model';
import employeeDeviceTypeModel from './database/employeeDeviceType.model';
import headquarterModel from './database/headquarter.model';
import orderModel from './database/order.model';
import priorityModel from './database/priority.model';
import responsibleModel from './database/responsible.model';
import sectorModel from './database/sector.model';
import ticketModel from './database/ticket.model';
import ticketCategoryModel from './database/ticketCategory.model';
import ticketStateModel from './database/ticketState.model';
import ticketSubCategoryModel from './database/ticketSubCategory.model';
import ticketTaskModel from './database/ticketTask.model';
